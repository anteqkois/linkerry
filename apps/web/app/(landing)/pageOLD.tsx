import { Button, buttonVariants } from '@linkerry/ui-components/server'
...
async function getGitHubStars(): Promise<string | null> {
  try {
    const stars = (await new Promise((r) => setTimeout(() => r('1023'), 1500))) as string
    return stars
  } catch (error) {
    return null
  }
      ...
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          ...
          <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl">
            An Powerful Connector for Traders to all Brokers
          </h1>
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            Connect your alert provider like Trading View, Maxdata to all brokersm and exchanges.
          </p>
      ...
      <section id="features" className="container space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            You can connect strategy alerts, events end other data to create one main strategy here. Everything in one
            place, all startegy plans togetger.
          </p>
        </div>
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">React 1</h3>
