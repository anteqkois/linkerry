...
export const AddAction = ({nodeId}: AddActionProps) => {
	...
	return (
		<div className="h-16 w-10 absolute -bottom-16 left-1/2 -translate-x-1/2 center">
			<span className="h-16 w-0.5 absolute left-1/2 -translate-x-1/2 center border border-muted-foreground/50 border-dashed -z-10" />
