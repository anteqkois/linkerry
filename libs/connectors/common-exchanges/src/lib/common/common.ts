import {
  DateTimeConfigOverwrite,
  DynamicDropdownConfigOverwrite,
  NumberConfigOverwrite,
  Property,
  StaticDropdownConfigOverwrite,
...
export const exchangeCommon = {
  ...
  margin_mode: (overwrite: StaticDropdownConfigOverwrite = {}) =>
