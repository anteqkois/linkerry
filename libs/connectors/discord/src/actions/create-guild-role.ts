...
export const discordCreateGuildRole = createAction({
  ...
  description: 'Creates a new role in a specified guild',
  descriptionLong: 'Create a new role in your Discord guild with specific permissions, colors, and settings to manage your community effectively.',
  props: {
