...
export type ProcessorFn<INPUT = any, OUTPUT = any> = (property: ConnectorProperty, value: INPUT) => OUTPUT
...
export type AnyProcessors = NumberProcessors | DateTimeProcessors
// | FileProcessors;
