...
export type CustomAuthProperty<T extends CustomAuthProps = CustomAuthProps> = CustomAuthPropertySchema<T> &
  PropertyValue<CustomAuthPropertyValue<T>, PropertyType.CUSTOM_AUTH, ValidationInputType.ANY, true>
