import { ConnectorPropertyMap, StaticPropsValue, } from '@linkerry/connectors-framework'
import { ExecuteTriggerOperation, ExecuteTriggerResponse, ScheduleOptions, TriggerConnector, TriggerHookType, TriggerStrategy, assertEqual } from '@linkerry/shared'
