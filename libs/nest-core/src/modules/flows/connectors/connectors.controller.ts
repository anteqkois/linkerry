import {
  ...
  RequestUser,
  connectorsGetOptionsInputSchema,
  connectorsMetadataGetManyQuerySchema,
  connectorsMetadataGetOneQuerySchema,
  stringShortSchema,
...
export class ConnectorsController {
  ...
  @Get(':name')
  findOne(
    @ParamSchema('name', stringShortSchema) name: string,
    @QuerySchema(connectorsMetadataGetOneQuerySchema) query: ConnectorsMetadataGetOneQuery,
  ) {
