import { FlowResponse, FlowRunResponse, FlowRunStatus, PauseType, isNil } from '@linkerry/shared'
...
export class FlowRunWatcherService implements OnApplicationBootstrap {
  ...
  private readonly FLOW_RUN_TIMEOUT_MS
  ...
  constructor(
    ...
    this.FLOW_RUN_TIMEOUT_MS = (+configService.get('FLOW_RUN_TIMEOUT_SECONDS') ?? 30) * 1000
