...
export class TriggerEventsController {
  ...
  @Get()
  getTriggerEvents(
    @QuerySchema(getTriggerEventsQuerySchema) query: GetTriggerEventsQuery,
    @ReqJwtUser() user: RequestUser
  ) {
  ...
  @UseGuards(JwtCookiesAuthGuard)
  @Delete()
  async deleteTriggerEvents(
    @BodySchema(deleteTriggerEventsInputSchema) body: DeleteTriggerEventsInput,
    @ReqJwtUser() user: RequestUser
  ) {
  ...
  @Post('/test/pool')
  create(
    @BodySchema(triggerPoolTestBodySchema) body: TriggerPoolTestBody,
    @ReqJwtUser() user: RequestUser
  ) {
